...
public class SimpleLinkedListImpl<E> implements LinkedList<E> {
    ...
    public void insert(E value) {
        Entry<E> newElement = new Entry<>(value);//002 ссылка
        newElement.setNext(firstElement);//001 ссылается на адрес next -> 001
...
//            assert previous != null;/ не нужа ли эта строка?
